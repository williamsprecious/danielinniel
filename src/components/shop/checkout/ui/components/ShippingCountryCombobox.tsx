...
type ShippingCountryComboboxProps = {
  value: string;
  onChange: (code: string) => void;
  countries: ReadonlyArray<ShippingCountryOption>;
  hasError?: boolean;
  placeholder?: string;
  disabled?: boolean;
};

const ShippingCountryCombobox = ({
  value,
  onChange,
  countries,
  hasError,
...
export default ShippingCountryCombobox;
